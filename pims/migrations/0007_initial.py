...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pims', '0006_remove_record_specialist_remove_record_user_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=20, verbose_name='診療科')),
            ],
        ),
        migrations.CreateModel(
            name='Record',
            fields=[
                ...
                ('image2', models.ImageField(blank=True, null=True, upload_to='attachment', verbose_name='イメージ2')),
